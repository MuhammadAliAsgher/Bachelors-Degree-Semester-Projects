            ...
            <table class="table table-bordered" style="font-family: Verdana">
              ...
              <center>
                <font style="font-family:Verdana; font-size:18px;">
                  Airport Authority Of Pakistan<br>
                  Flight Running on <?php echo '' . $row[3] . '   ' ?> [ From : <?php echo '' . $row[1] . '   ' ?> To :
                  <?php echo '' . $row[2] . '   ' ?>]
                </font>
              </center>
              ...
              <tr>
                <td>
                  <font style="font-family: Verdana;">Flight</font>
                </td>&nbsp&nbsp Jet ID:<?php echo '' . $row[11] . '   ' ?>
              ...
              <tr>
                ...
                <td colspan="3"> <?php echo '' . $row[1] . '   ' ?>   <?php echo '' . $row[5] . '   ' ?>
                  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                  <?php echo ' To - ' . $row[2] ?>  <?php echo '' . $row[6] . '   ' ?>
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <font style="font-family: Verdana;">Arrival Date</font>
                </td>
                <td> <?php echo $row[4] ?></td><br>&nbsp&nbsp
                <td>
                  <font style="font-family: Verdana;"> Price Economy Class</font>
                </td>
                <td> <?php echo $row[9] ?> </td>
                <td>
                  <font style="font-family: Verdana;"> Price Business class</font>
                </td>
