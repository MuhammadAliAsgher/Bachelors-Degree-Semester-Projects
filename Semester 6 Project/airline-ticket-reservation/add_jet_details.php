	...
	<div class="container-fluid mx-5">
		<div class="row">
			...
			<form action="admin_view_booked_tickets_form_handler.php" method="post">
				...
				<div class="col col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
					<h4>Enter the Jet Type/Model</h4>
					<h4><input type="text" name="jet_type" required></h4>
				</div>
				<br>

				<div class="col col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
					<h4>Enter the total capacity of the Jet</h4>
					<h4><input type="number" name="jet_capacity" required></h4>
				</div>
				<br>
