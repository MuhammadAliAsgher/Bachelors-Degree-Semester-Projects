        ...
        <div class="container-fluid">
            ...
            <div id="divtop">
                <center>
                    ...
                    <br> <br><br>
                    <div id="dmain">
                        <center><img src="./images/pia_logo.png" width="180px" height="150px"></center>
                        <br>
                        <input type="text" id="u_id" name="pnr" class="form-control"
                            style="width:300px; margin-left: 66px;" placeholder="Enter Your PNR Number"><br>

                        <input type="submit" id="u_sub" name="u_sub" value="Check" class="toggle btn btn-primary"
                            style="width:100px; margin-left: 70px;"><br>
