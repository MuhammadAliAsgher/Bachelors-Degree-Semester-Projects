...
System.out.println("A");
                    ...
                    int routeNum1 = Integer.parseInt(tripInfo[1][0])-1;
                    int startStop1 = Integer.parseInt(tripInfo[1][1]);
                    int destStop1 = Integer.parseInt(tripInfo[1][3]);
                    int routeNum2 = Integer.parseInt(tripInfo[1][5]);
                    int startStop2 = Integer.parseInt(tripInfo[1][6]);
                    int startStop8 = Integer.parseInt(tripInfo[1][8]);
                    int busNum1 = 0, busNum2 = 0;
                    int i = 0;
                    boolean flag1 = true;
                    while (flag1 && i < 10){
                        int temp1 = (h-buses[routeNum1][i].StartHour)%2;
                        if (temp1 < 0){
                            temp1*=-1;
                        }
                        int temp2 = 0;
                        temp2 = (m-buses[routeNum1][i].StartMin)/6;
                        if (temp2<0){
                            temp2 += 10;
                        }
                        System.out.println(i + " " + startStop1 + " " + temp2 + " " + buses[routeNum1][i].StartMin);
                        if (startStop1==temp2+1){
                            busNum1 = i;
                            flag1 = false;
                            break;
                        }
                    ...
                    buses[routeNum1][busNum1].InitSeats(routeNum1+1,busNum1+1, u.gender);
                    AddSeatLabels(routeNum1+1,busNum1+1);
                    int min = (6-(time.minute%6));
                    resLab.setText("Route Num " + (routeNum1+1) + " Bus Num " + (busNum1+1) + " is " + min + " minutes away " + "Fare = " + 50);
                    int temp1 = Math.abs((destStop1 - startStop1)) * 6, temp2 = 0;
                    ...
                    b1 = new BookingDetails(routeNum1,busNum1,0,0,time,u);
                    int j = 0;
                    boolean flag2 = true;
                    while (flag2 && j < 10){
                        int temp3 = (h-buses[routeNum2][j].StartHour)%2;
                        if (temp3 < 0){
                            temp3*=-1;
                        }
                        int temp4 = 0;
                        temp4 = (m-buses[routeNum1][i].StartMin)/6;
                        if (temp4<0){
                            temp4 += 10;
                        }
                        System.out.println(j + " " + startStop2 + " " + temp4 + " " + buses[routeNum2][j].StartMin);
                        if (startStop2==temp4+1){
                            busNum2 = j;
                            flag2 = false;
                            break;
                        }
                    ...
                    buses[routeNum2][busNum2].InitSeats(routeNum2+1,busNum2+1, u.gender);
                    AddSeatLabels(routeNum2+1,busNum2+1);
                    int min1 = (6-(time.minute%6));
                    resLab.setText("Route Num " + (routeNum2+1) + " Bus Num " + (busNum2+1) + " is " + min1 + " minutes away " + "Fare = " + 50);
                    int temp5 = Math.abs((destStop1 - startStop1)) * 6, temp6 = 0;
                    temp5 += time.minute + min1;
                    if (temp5>=60){
                        time.hour += 1;
                        temp6 -= 60;
                    }
                    ...
                    b2 = new BookingDetails(routeNum2,busNum2,0,0,time,u);
